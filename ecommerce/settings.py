...
#DATABASES = {
   # 'default': {
        ...
        #'NAME': config('DB_NAME', default='ecommerce_development'),
        #'USER': config('DB_USER', default='sasikalavijayakumar'),
        #'PASSWORD': config('DB_PASSWORD', default='yourpassword'),
        #'HOST': config('DB_HOST', default='localhost'),
        #'PORT': config('DB_PORT', default='5432'),
    #}
#}
# Commented out PostgreSQL configuration for local development
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': 'pragathi',
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "https://pragathinaturalfarm.com",
    "https://www.pragathinaturalfarm.com",
]
